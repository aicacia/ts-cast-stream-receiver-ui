...
},{}],"../node_modules/ts-polyfill/dist/ts-polyfill.js":[function(require,module,exports) {
...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/@aicacia/hash/lib/hash.js":[function(require,module,exports) {
"use strict";
// https://github.com/facebook/immutable-js/blob/master/src/Hash.js
Object.defineProperty(exports, "__esModule", { value: true });
exports.hash = exports.USING_WEAK_MAP = exports.STRING_HASH_CACHE_MAX_SIZE = exports.STRING_HASH_CACHE_MIN_STRLEN = void 0;
exports.STRING_HASH_CACHE_MIN_STRLEN = 16;
exports.STRING_HASH_CACHE_MAX_SIZE = 255;
...
exports.USING_WEAK_MAP = typeof WeakMap === "function";
let WEAK_MAP;
if (exports.USING_WEAK_MAP) {
...
const hash = (o) => {
    switch (typeof o) {
        ...
        case "number":
            return hashNumber(o);
        case "string":
            return o.length > exports.STRING_HASH_CACHE_MIN_STRLEN
                ? cachedHashString(o)
                : hashString(o);
        case "object":
        case "function":
...
const cachedHashString = (str) => {
    let hashed = stringHashCache[str];
    if (hashed === undefined) {
        hashed = hashString(str);
        if (STRING_HASH_CACHE_SIZE === exports.STRING_HASH_CACHE_MAX_SIZE) {
...
const hashJSObj = (obj) => {
    ...
    if (exports.USING_WEAK_MAP) {
        ...
        obj.propertyIsEnumerable = function (...args) {
...
},{}],"../node_modules/@aicacia/hash/lib/index.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.USING_WEAK_MAP = exports.STRING_HASH_CACHE_MIN_STRLEN = exports.STRING_HASH_CACHE_MAX_SIZE = exports.hash = void 0;
var hash_1 = require("./hash");
Object.defineProperty(exports, "hash", { enumerable: true, get: function () { return hash_1.hash; } });
Object.defineProperty(exports, "STRING_HASH_CACHE_MAX_SIZE", { enumerable: true, get: function () { return hash_1.STRING_HASH_CACHE_MAX_SIZE; } });
Object.defineProperty(exports, "STRING_HASH_CACHE_MIN_STRLEN", { enumerable: true, get: function () { return hash_1.STRING_HASH_CACHE_MIN_STRLEN; } });
Object.defineProperty(exports, "USING_WEAK_MAP", { enumerable: true, get: function () { return hash_1.USING_WEAK_MAP; } });

},{"./hash":"../node_modules/@aicacia/hash/lib/hash.js"}],"../package.json":[function(require,module,exports) {
module.exports = {
  "name": "cast-stream-receiver-ui",
  "private": true,
  ...
  "engineStrict": true,
  "description": "aicacia cast-stream-receiver ui",
  "repository": {
    "type": "git",
    "url": "https://gitlab.com/aicacia/ts-cast-stream-receiver-ui.git"
  },
  "main": "./src/index.html",
  "scripts": {
    "gulp": "gulp",
  ...
  "keywords": ["aicacia", "cast-stream-receiver", "ui"],
  "author": "Nathan Faucett",
  "license": "(MIT OR Apache-2.0)",
  "readmeFilename": "README.md",
  "devDependencies": {
    "@types/chromecast-caf-receiver": "5",
    "@types/gulp": "4",
    "@types/node": "14",
...
var NAMSPACE = "urn:x-cast:aicacia",
    VIDEO_ID = "video";
...
function onLoad() {
  ...
  options.versionCode = hash_1.hash(package_json_1.default.version);
  options.customNamespaces = _defineProperty({}, NAMSPACE, "JSON");
  context.setLoggerLevel(undefined === "production" ? cast.framework.LoggerLevel.INFO : cast.framework.LoggerLevel.DEBUG);
...
function onResize() {
  cast.framework.CastReceiverContext.getInstance().sendCustomMessage(NAMSPACE, undefined, {
    type: "resize",
...
function onInit() {
  ...
  pc.addEventListener("negotiationneeded", function () {
    ...
    pc.createOffer().then(onLocalDescCreated).catch(createOnError("negotiationneeded"));
  });
  ...
  cast.framework.CastReceiverContext.getInstance().addCustomMessageListener(NAMSPACE, function (event) {
    var data = event.data;
    ...
    switch (data.type) {
      case "sdp":
        {
          pc.setRemoteDescription(new RTCSessionDescription(data.sdp)).then(function () {
            ...
            if (((_a = pc.remoteDescription) === null || _a === void 0 ? void 0 : _a.type) === "offer") {
              pc.createAnswer().then(onLocalDescCreated).catch(createOnError("createAnswer"));
            }
      ...
      case "candidate":
        {
          pc.addIceCandidate(new RTCIceCandidate(data.candidate)).catch(createOnError("addIceCandidate"));
          break;
        }
    }
  });
...
function onLocalDescCreated(desc) {
  ...
  return pc.setLocalDescription(desc).then(function () {
    return cast.framework.CastReceiverContext.getInstance().sendCustomMessage(NAMSPACE, undefined, {
      type: "sdp",
...
},{"tslib":"../node_modules/tslib/tslib.es6.js","ts-polyfill":"../node_modules/ts-polyfill/dist/ts-polyfill.js","@aicacia/hash":"../node_modules/@aicacia/hash/lib/index.js","../package.json":"../package.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36567" + '/');
